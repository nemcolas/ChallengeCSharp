...
namespace OdontoPrevCSharp.Controllers
{
    public class GenerosController : Controller
    {
        ...
        public GenerosController(OdontoPrevContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,Descricao")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,Descricao")] Genero genero)
        {
